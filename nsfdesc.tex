...
\subsubsection*{B) How do the fitness of parental and hybrid populations vary across the hybrid zone?} \jri{reading this now i kind of think switching B and A here and leading with common garden would be good.  everyone is sequencing everything these days, doing the hard common garden work is one thing that will set us apart} \mbh{Heh, that was my logic in putting it last...thought reviewers would have it more in their minds after reading the proposal.  I think that worked for the pre-proposal...the reviewers all mentioned the strength of proposing gardens}.
