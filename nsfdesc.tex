...
%\mbh{I like the result and think the lower Fst of hybrids vs parv \& mex than parv vs mex adds something...I'd like to keep it in unless we come up against space constraints.}
...
\subsubsection*{IA. What fraction of the genome is porous to gene flow in hybrid zones?}
...
\subsubsection*{IB. How do the fitness of parental and hybrid populations vary across the hybrid zone?} \jri{reading this now i kind of think switching B and A here and leading with common garden would be good.  everyone is sequencing everything these days, doing the hard common garden work is one thing that will set us apart} \mbh{Heh, that was my logic in putting it last...thought reviewers would have it more in their minds after reading the proposal.  I think that worked for the pre-proposal...the reviewers all mentioned the strength of proposing gardens}.
...
\subsubsection*{IIB. What is the geographic scale of adaptive introgression?}\label{subsec:scale}
...
\subsubsection*{IIC. Did maize serve as a bridge for gene flow between previously isolated Zea taxa?}\label{subsec:bridge}

While our preliminary analyses suggest that maize has served as a bridge for gene flow between \emph{mexicana} and \emph{luxurians} and potentially other \emph{Zea} taxa (see above), an alternative explanation is that "bridged" loci were polymorphic in the common ancestor of these taxa and continue to segregate due to incomplete lineage sorting.
...
These populations, combined with samples from other teosinte populations included in Objectives IIA and IIB, will provide us with a representative sample of wild teosinte populations from across the Americas.
We will use a number of methods, including HapMix \citep{price2009}, relative nucleotide differences \citep(XXX) \mbh{do you have a particular method/software in mind here?}, and fineSTRUCTURE \citep{lawson2012} to compare across these sets of populations to identify shared haplotype segments.
Although we do not have a genetic map for most teosinte taxa, evidence from comparison among maize populations finds remarkable stability of the genetic map at a relatively coarse scale \citep(XXX). \mbh{Were you thinking of the Bauer paper? They seem to argue the opposite.}
...
We will also scan a large sample of $>16,000$ maize samples that have been genotyped with GBS \url{www.panzea.org} to look for the presence of such haplotypes in domesticated maize.
